...
<head>
    <meta charset="UTF-8">
    <title>@yield('title','VibeMart Admin')</title>
...
<div class="vm-admin-wrapper">
    ...
    <aside class="vm-sidebar">
        ...
        <ul class="vm-nav">
            ...
            <li>
                <a href="{{ route('admin.products.index') }}" class="vm-nav-link">
        ...
        <div class="vm-sidebar-footer mt-3">
            ...
            <div class="text-light">{{ auth()->user()->name ?? 'Admin' }}</div>
        </div>
    </aside>
    ...
    <div class="vm-main">
        ...
        <header class="vm-topbar">
            <div class="vm-topbar-title">
                @yield('breadcrumb','Admin / Dashboard') ·
