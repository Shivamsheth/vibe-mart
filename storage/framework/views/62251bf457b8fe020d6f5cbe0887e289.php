    ...
    <div class="row g-0 shadow-lg rounded-4 overflow-hidden">
        ...
        <div class="col-lg-5 brand-panel d-flex flex-column justify-content-between">
            ...
            <div class="small text-secondary">
                ...
                <a href="<?php echo e(route('login.view')); ?>" class="link-light fw-semibold text-decoration-none ms-1">
                    Sign in instead →
                </a>
            </div>
        </div>
...
<?php /**PATH C:\major-project\vibe-mart\resources\views/auth/register.blade.php ENDPATH**/ ?>