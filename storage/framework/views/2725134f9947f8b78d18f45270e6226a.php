...
<head>
    <meta charset="UTF-8">
    <title><?php echo $__env->yieldContent('title','VibeMart Admin'); ?></title>
...
<div class="vm-admin-wrapper">
    ...
    <aside class="vm-sidebar">
        ...
        <ul class="vm-nav">
            <li>
                <a href="<?php echo e(route('admin.dashboard')); ?>"
                   class="vm-nav-link <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>">
        ...
        <div class="vm-sidebar-footer mt-3">
            ...
            <div class="text-light"><?php echo e(auth()->user()->name ?? 'Admin'); ?></div>
        </div>
    </aside>
    ...
    <div class="vm-main">
        ...
        <header class="vm-topbar">
            <div class="vm-topbar-title">
                <?php echo $__env->yieldContent('breadcrumb','Admin / Dashboard'); ?> ·
            ...
            <div class="vm-user">
                ...
                <span><?php echo e(auth()->user()->email ?? 'admin@example.com'); ?></span>
            </div>
        </header>
        ...
        <main class="vm-content">
            <div class="vm-page-header">
                <div>
                    <div class="vm-page-title"><?php echo $__env->yieldContent('page_title','Dashboard'); ?></div>
                </div>
            </div>
...
<?php /**PATH C:\major-project\vibe-mart\resources\views/layouts/admin.blade.php ENDPATH**/ ?>