...
<head>
    <meta charset="UTF-8">
    <title><?php echo $__env->yieldContent('title','VibeMart'); ?></title>
...
<div class="vm-admin-wrapper">
    ...
    <aside class="vm-sidebar">
        ...
        <ul class="vm-nav">
            <li>
                <a href="<?php echo e(route('home')); ?>"
                   class="vm-nav-link <?php echo e(request()->routeIs('home') ? 'active' : ''); ?>">
        ...
        <div class="vm-sidebar-footer mt-3">
            ...
            <div class="text-light"><?php echo e(auth()->user()->name ?? 'Customer'); ?></div>
        </div>
    </aside>
    ...
    <div class="vm-main">
        ...
        <header class="vm-topbar">
            ...
            <div class="vm-user">
                ...
                <span><?php echo e(auth()->user()->email ?? 'customer@example.com'); ?></span>
            </div>
        </header>
...
<?php /**PATH C:\major-project\vibe-mart\resources\views/layouts/customer.blade.php ENDPATH**/ ?>