    ...
    <div class="row g-0 shadow-lg rounded-4 overflow-hidden">
        ...
        <div class="col-lg-5 brand-panel d-flex flex-column justify-content-between">
            ...
            <div class="small text-secondary">
                ...
                <a href="<?php echo e(route('register.view')); ?>" class="link-light fw-semibold text-decoration-none ms-1">
                    Create an account →
                </a>
            </div>
        </div>
        ...
        <div class="col-lg-7 form-panel">
            ...
            <form id="loginForm" novalidate>
                ...
                <div class="text-center mt-3 small text-muted">
                    ...
                    <a href="<?php echo e(route('register.view')); ?>" class="text-primary text-decoration-none">Register now</a>
                </div>
            </form>
        </div>
    </div>
...
<?php /**PATH C:\major-project\vibe-mart\resources\views/auth/login.blade.php ENDPATH**/ ?>