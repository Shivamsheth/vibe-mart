    ...
    <div class="row g-0 shadow-lg rounded-4 overflow-hidden">
        ...
        <div class="col-lg-5 brand-panel d-flex flex-column justify-content-between">
            ...
            <div class="small text-secondary">
                ...
                <a href="<?php echo e(route('resend.view')); ?>" class="link-light fw-semibold text-decoration-none ms-1">
                    Resend OTP →
                </a>
            </div>
        </div>
            ...
            <form id="verifyForm" novalidate>
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <small class="text-muted">
                        Didn’t get the code?
                        <a href="<?php echo e(route('resend.view')); ?>" class="text-primary text-decoration-none">
                            Resend OTP
                        </a>
                    </small>
                    <small class="text-muted">
...
<?php /**PATH C:\major-project\vibe-mart\resources\views/auth/verify-otp.blade.php ENDPATH**/ ?>